...
return {
    ...
    animations = {
        ...
        { leaf = "windowsIn",  enabled = true, speed = 3,   spring = "pop",  style = "popin 90%" },
        { leaf = "windowsOut", enabled = true, speed = 2, bezier = "ease", style = "popin 92%" },
