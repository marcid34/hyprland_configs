...
// vellum — the whole design system.
//
...
Singleton {
    // ── surface ──────────────────────────────────────────────────────────
    readonly property color bg:   "#f6f2ea"    // desktop floor
    readonly property color bg1:  "#fffdf7"   // resting surface
    readonly property color bg2:  "#efe9dd"   // raised / hovered
    readonly property color bg3:  "#ded6c6"   // hairline

    // ── ink ──────────────────────────────────────────────────────────────
    readonly property color fg:    "#2c2823"
    readonly property color fg1:   "#4d463d"
    readonly property color dim:   "#7d7466"
    readonly property color faint: "#a89e8d"

    // ── signal ───────────────────────────────────────────────────────────
    readonly property color accent:  "#6d8f63"
    readonly property color accent2: "#b38a52"
    readonly property color red:     "#b5524a"
    readonly property color green:   "#6d8f63"
    readonly property color yellow:  "#b38a52"
