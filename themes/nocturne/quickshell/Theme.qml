...
// nocturne — the whole design system.
//
...
Singleton {
    // ── surface ──────────────────────────────────────────────────────────
    readonly property color bg:   "#0a0b13"    // desktop floor
    readonly property color bg1:  "#11131e"   // resting surface
    readonly property color bg2:  "#171a28"   // raised / hovered
    readonly property color bg3:  "#232739"   // hairline

    // ── ink ──────────────────────────────────────────────────────────────
    readonly property color fg:    "#eaecf8"
    readonly property color fg1:   "#c8cce4"
    readonly property color dim:   "#9096b4"
    readonly property color faint: "#626883"

    // ── signal ───────────────────────────────────────────────────────────
    readonly property color accent:  "#8c9cff"
    readonly property color accent2: "#b9a4ff"
    readonly property color red:     "#ff8b9e"
    readonly property color green:   "#7fdfae"
    readonly property color yellow:  "#f6cd83"
