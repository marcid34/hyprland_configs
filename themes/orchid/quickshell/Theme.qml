...
// orchid — the whole design system.
//
...
Singleton {
    // ── surface ──────────────────────────────────────────────────────────
    readonly property color bg:   "#110d17"    // desktop floor
    readonly property color bg1:  "#191323"   // resting surface
    readonly property color bg2:  "#221a30"   // raised / hovered
    readonly property color bg3:  "#2f2440"   // hairline

    // ── ink ──────────────────────────────────────────────────────────────
    readonly property color fg:    "#f2ecf8"
    readonly property color fg1:   "#d5c8e2"
    readonly property color dim:   "#a292b4"
    readonly property color faint: "#6f6382"

    // ── signal ───────────────────────────────────────────────────────────
    readonly property color accent:  "#c294ff"
    readonly property color accent2: "#ff9fd8"
    readonly property color red:     "#ff8ba0"
    readonly property color green:   "#93e0b8"
    readonly property color yellow:  "#f5cc85"
