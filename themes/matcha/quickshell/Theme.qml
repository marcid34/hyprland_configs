...
// matcha — the whole design system.
//
...
Singleton {
    // ── surface ──────────────────────────────────────────────────────────
    readonly property color bg:   "#0c0f0b"    // desktop floor
    readonly property color bg1:  "#141911"   // resting surface
    readonly property color bg2:  "#1b2117"   // raised / hovered
    readonly property color bg3:  "#272f20"   // hairline

    // ── ink ──────────────────────────────────────────────────────────────
    readonly property color fg:    "#eaf0e3"
    readonly property color fg1:   "#ccd6c0"
    readonly property color dim:   "#97a389"
    readonly property color faint: "#68735c"

    // ── signal ───────────────────────────────────────────────────────────
    readonly property color accent:  "#a9d84c"
    readonly property color accent2: "#6fd39c"
    readonly property color red:     "#f08b7f"
    readonly property color green:   "#a9d84c"
    readonly property color yellow:  "#e6c65c"
