...
// halcyon — the whole design system.
//
...
Singleton {
    // ── surface ──────────────────────────────────────────────────────────
    readonly property color bg:   "#0f0e11"    // desktop floor
    readonly property color bg1:  "#17151b"   // resting surface
    readonly property color bg2:  "#1f1c25"   // raised / hovered
    readonly property color bg3:  "#2b2733"   // hairline

    // ── ink ──────────────────────────────────────────────────────────────
    readonly property color fg:    "#f4f0f5"
    readonly property color fg1:   "#cdc5d1"
    readonly property color dim:   "#9a90a3"
    readonly property color faint: "#6b6275"

    // ── signal ───────────────────────────────────────────────────────────
    readonly property color accent:  "#ff8f6e"
    readonly property color accent2: "#ffbfa0"
    readonly property color red:     "#ff7a7a"
    readonly property color green:   "#8fd9a8"
    readonly property color yellow:  "#ffc978"
