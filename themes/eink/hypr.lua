...
return {
    general = {
        ...
        border_size = 1,
        col = {
            active_border   = "rgba(111111ff)",
            inactive_border = "rgba(ebebe6ff)",
        },
    },
    decoration = {
        rounding = 0, rounding_power = 2,
        active_opacity = 1.0, inactive_opacity = 1.0,
        dim_inactive = true, dim_strength = 0.3,
    ...
    animations = {
        ...
        { leaf = "windowsIn",  enabled = true, speed = 2,   spring = "pop",  style = "popin 96%" },
        { leaf = "windowsOut", enabled = true, speed = 1, bezier = "ease", style = "popin 96%" },
